...
public class samplemoveforcourse6_2 : MonoBehaviour
{
    private float _time;
    List<Vector3> _pos;
    ...
    private Vector3 pos20_1 = new Vector3(0.481f, 0.8452f, 0.648f);
    ...
    void OnEnable()
    {
        _interbal.Add(0);
        _interbal.Add(3);
        _pos = new List<Vector3>() { startpos, startpos, pos1, pos2, pos3, pos4, pos5, pos6, pos7, pos8, pos9, pos10, pos11, pos12, pos13, pos14, pos15, pos16, pos17, pos18, pos19, pos20,pos20_1, pos20_1, pos21, pos22, pos23, pos24, pos25, pos26, pos27, pos28, pos29, pos30, pos31, pos32, pos33, pos34, pos35, pos36, pos37, pos38, pos39, pos40, pos41, pos42, pos43, pos44, pos45, pos46, pos47, pos48, pos49, pos50, pos51, pos52, pos53, pos53 };

        for (int i = 0; i < _pos.Count; i++)
        {
            if (i < 22)
            {
                _pos[i] += new Vector3(0.4f, 0, 0);
            }
            else if (i > 23)
            {
                _pos[i] = new Vector3(0.45f - _pos[i].x, _pos[i].y, _pos[i].z);
            }
        }

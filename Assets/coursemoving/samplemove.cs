...
public class samplemove : MonoBehaviour
{
    ...
    private Vector3 pos21 = new Vector3(0.623f,0.832f, 0.648f);
    private Vector3 pos22 = new Vector3(0.623f,1.265f, 0.648f);
    private Vector3 pos23 = new Vector3(0.241f,1.265f, 0.648f);
    private Vector3 pos24 = new Vector3(0.241f,1.033f, 0.648f);
    private Vector3 pos25 = new Vector3(0.538f,1.033f, 0.648f);
    private Vector3 pos26 = new Vector3(0.538f,0.924f, 0.648f);
    private Vector3 pos27 = new Vector3(0.133f,0.924f, 0.648f);
    private Vector3 pos28 = new Vector3(0.133f,1.363f, 0.648f);
    private Vector3 pos29 = new Vector3(0.614f,1.363f, 0.648f);
    private Vector3 pos30 = new Vector3(0.614f,1.461f, 0.648f);
    private Vector3 pos31 = new Vector3(0.153f,1.461f, 0.648f);
    private Vector3 pos32 = new Vector3(0.153f,1.544f, 0.648f);
    private Vector3 pos33 = new Vector3(0.719f,1.544f, 0.648f);
    private Vector3 pos34 = new Vector3(0.719f,0.849f, 0.648f);
    private Vector3 pos35 = new Vector3(0.811f,0.849f, 0.648f);
    private Vector3 pos36 = new Vector3(0.811f,1.499f, 0.648f);
    private Vector3 pos37 = new Vector3(0.907f,1.499f, 0.648f);
    private Vector3 pos38 = new Vector3(0.907f,0.833f, 0.648f);
    private Vector3 pos39 = new Vector3(1.036f,0.833f, 0.648f);
    float[] _interbal = {0,3,1.8f,2.7f,0.6f,4f,0.6f,4f,0.5f,2.6f,2f,0.6f,1.3f,0.5f,1.3f,0.5f,1.5f,0.6f,2.5f,2.8f,1.8f,0.6f,5f,2.5f,2.6f,1.8f,1.8f,0.6f,3.2f,3.2f,3.2f,0.6f,3.2f,0.6f,3.2f,4.4f,0.6f,4.4f,0.6f,4.3f,0.8f,1f};
    ...
    void OnEnable()
    {
        _pos = new List<Vector3>() {startpos,startpos,pos1, pos2, pos3, pos4, pos5, pos6, pos7, pos8, pos9, pos10, pos11, pos12, pos13, pos14, pos15, pos16, pos17, pos18, pos19, pos20, pos21, pos22, pos23, pos24, pos25, pos26, pos27, pos28, pos29, pos30, pos31, pos32, pos33, pos34, pos35, pos36, pos37, pos38, pos39,pos39};
